...
<body>
	...
	<!-- 内容 -->
	<div class="container" style="position:relative;top:20px;height:1000px">
		<!-- 列表组 -->
		<div class="row">
			...
			<div class="col-md-3" style="left:-35px;">
				...
				<div class="list-group" id="shu-daohanglan" style="width:200px;">
					<a href="#" class="list-group-item" id="shu-daohanglan-title"
						...
						href="products_Release.jsp" class="list-group-item">发布产品</a> <a href="#"
			...
			<div class="col-md-9" style="left:-80px;">
				...
				<div>
					<div class="test2-cgx" style="">
						<a href="#" style="">草稿箱(10)</a>
					</div>
					<div class="test2-cgx" style="margin-left:3px">
						<a href="products_Management_examining.jsp" style="">审核中(2)</a>
					</div>
					<div class="test2-cgx" style="margin-left:3px">
						<a href="#" style="">审核不通过(2)</a>
					</div>
					<div class="test2-cgx" style="margin-left:3px;background:#EE2C2C;">
						<a href="G_yixiajiaGetall" style="color:#ffffff;">已下架(2)</a>
					</div>
					<div class="test2-cgx" style="margin-left:3px;">
						<a href="#" style="">正在销售(12)</a>
					</div>
				</div>
				...
				<!-- 内容 -->
				<div
					style="background:#ffffff;width:1000px;height:900px;position:relative;top:60px;">
