	...
	<div class="container" style="position: relative; top: 20px">
		...
		<div class="row">
			...
			<div class="col-md-3" style="left: 35px;">
				<div class="list-group" id="shu-daohanglan" style="width: 200px;">
					<a href="../S_Shop/select.jsp" class="list-group-item"
						...
						style="font-size: 18px; font-weight: bold;">店铺管理</a> <a
						href="../S_Shop/select.jsp" class="list-group-item"
					...
					<a href="../S_Shop/manager_pro.jsp"
						class="list-group-item" style="background: #F5F5F5; color: #EE7621;">管理产品</a> <a
			...
			<div class="col-md-9">
				<!-- 页面名称 -->
				<div>
					<p style="font-size: 18px; font-weight: bold;">管理产品</p>
				</div>
				...
				<div style="background: #fff; width: 800px;">
					...
					<div style="background: #C2C2C2; height: 40px; width: 800px;">
						...
						<p
							style="font-size: 14px; position: relative; top: -108px; left: 655px;">销售价</p>
						<p
							style="font-size: 14px; position: relative; top: -138px; left: 750px;">下架</p>
					</div>
					<div style="background: #fff; width: 800px;">
						<table id="message-list" style="table-layout: fixed;">
							<thead>
								<tr style="background: #fff; height: 30px;">
									...
									<th width="13%" align="center">150</th>
									<th width="10%" align="center" bgcolor="#ffffff"><input type="button" value="下架" 
									style="color:red;backgroung:#ffffff" id="b" onclick="change(this)" /></th>
								</tr>
								<tr style="background: #E0FFFF; height: 30px;">
									<th width="40%" align="center">深圳市鸿之捷实业发展有限公司</th>
									<th width="20%" align="center">球鞋</th>
									<th width="12%" align="center">1254</th>
									<th width="12%" align="center">315</th>
									<th width="13%" align="center">412</th>
									<th width="10%" align="center" bgcolor="#ffffff"><input type="button" value="下架" 
									style="color:red;backgroung:#ff0" id="b" onclick="change(this)" /></th>
								</tr>
								<tr style="background: #fff; height: 30px;">
									<th width="40%" align="center">东莞市风格鞋业有限公司</th>
									<th width="20%" align="center">休闲鞋</th>
									<th width="12%" align="center">16545</th>
									<th width="12%" align="center">165</th>
									<th width="13%" align="center">265</th>
									<th width="10%" align="center" bgcolor="#ffffff"><input type="button" value="下架" 
									style="color:red" id="b" onclick="change(this)" /></th>
								</tr>
								<tr style="background: #E0FFFF; height: 30px;">
									<th width="40%" align="center">深圳市瑞新达实业有限公司</th>
									<th width="20%" align="center">童装</th>
									<th width="12%" align="center">45612</th>
									<th width="12%" align="center">40</th>
									<th width="13%" align="center">85</th>
									<th width="10%" align="center" bgcolor="#ffffff"><input type="button" value="下架" 
									style="color:red;backgroung:#ff0" id="b" onclick="change(this)" /></th>
								</tr>
								<tr style="background: #fff; height: 30px;">
									<th width="40%" align="center">深圳市瑞新达实业有限公司</th>
									<th width="20%" align="center">T恤</th>
									<th width="12%" align="center">26554</th>
									<th width="12%" align="center">56</th>
									<th width="13%" align="center">99</th>
									<th width="10%" align="center" bgcolor="#ffffff"><input type="button" value="下架" 
									style="color:red" id="b" onclick="change(this)" /></th>
								</tr>
								<tr style="background: #E0FFFF; height: 30px;">
								...
								<tr style="background: #fff; height: 30px;">
									<th width="40%" align="center">深圳市迦德堡(奇奇库童装)实业有限公司</th>
									<th width="20%" align="center">肯笛儿</th>
									<th width="12%" align="center">4245</th>
									<th width="12%" align="center">100</th>
									<th width="13%" align="center">169</th>
									<th width="10%" align="center" bgcolor="#ffffff"><input type="button" value="下架" 
									style="color:red" id="b" onclick="change(this)" /></th>
								</tr>
								<tr style="background: #E0FFFF; height: 30px;">
									<th width="40%" align="center">衣恋实业(深圳)有限公司</th>
									<th width="20%" align="center">休闲服</th>
									<th width="12%" align="center">15000</th>
									<th width="12%" align="center">50</th>
									<th width="13%" align="center">78</th>
									<th width="10%" align="center" bgcolor="#ffffff"><input type="button" value="下架" 
									style="color:red;backgroung:#ff0" id="b" onclick="change(this)" /></th>
								</tr>
								<tr style="background: #fff; height: 30px;">
									<th width="40%" align="center">衣恋实业(深圳)有限公司</th>
									<th width="20%" align="center">女装</th>
									<th width="12%" align="center">46000</th>
									<th width="12%" align="center">49</th>
									<th width="13%" align="center">68</th>
									<th width="10%" align="center" bgcolor="#ffffff"><input type="button" value="下架" 
									style="color:red;backgroung:#ff0" id="b" onclick="change(this)" /></th>
								</tr>
							</thead>
