			...
			<ul>
				...
				<li class="first-nav"><span><a href="../S_Shop/select.jsp">店铺管理</a>
					...
					<ul class="sec-nav" style="background: #ffffff;">
						...
						<li><a href="../S_Shop/manager_pro.jspt1.jsp">管理产品</a></li>
				...
				<li class="dropdown  first-nav" style="background: #FF8C69;"><span>
						<a href="../messages1/messages.jsp">消息中心</a><i
						class="icon icon-arrow"></i>
				</span>
					<ul class="sec-nav">
						<li><a href="messages.jsp">站内信</a></li>
						<li><a href="#">垃圾箱</a></li>
