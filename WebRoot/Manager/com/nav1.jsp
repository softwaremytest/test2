     ...
     由于顶层容器是适应浏览器变化宽度，所以可以保持水平导航栏自适应浏览器窗口宽度保持居中-->
		<div class="top-wrapper wrapper">
			...
			<div class="nav top-left-nav">
				...
				<ul>
					<li class="first-nav"
						style="position: relative; left: 50px; width: 240px;"><span><a
							href="sup_man.jsp">供应商管理</a> </span></li>
					<li class="first-nav"
						style="position: relative; left: 50px; width: 240px;"><span><a
					...
					<li class="dropdown  first-nav"
						style="position: relative; left: 50px; width: 240px; background: #FF8C69;"><span>
							<a href="messages.jsp">消息中心</a><i class="icon icon-arrow"></i>
					</span>
						<ul class="sec-nav" style="width: 240px;">
							<li><a href="messages.jsp">发布通知</a></li>
							<li><a href="mes_management.jsp">通知管理</a></li>
