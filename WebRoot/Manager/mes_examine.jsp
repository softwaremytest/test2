	...
	<c:if test="${not  empty User}">
		<div class="container"
			...
			<div class="row">
				...
				<div class="col-md-9">
					<!-- 分类 -->
					<div style="width: 320px;height: 40px;background:#FF8C69;padding-top:10px;padding-left:10px;">
						<div style="width: 150px;height: 40px;text-align: center;padding:10px;background:#EED8AE;top:-10px;position: relative;">
							<a href="mes_examine.jsp" style="">供应商</a>
						</div>
						<div style="width: 150px;height: 40px;text-align: center;padding:10px;background:#FF8C69;top: -50px; left:158px;position: relative;">
					...
					style="background: #ff0000; width: 750px; height: 1px; top: 15px; position: relative;"></div>
						<jsp:include page='${"../SupServlet" }'>
							<jsp:param name="type" value="listsuppliers" />
