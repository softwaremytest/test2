			...
			<div class="row">
				...
				<div class="col-md-3" style="left: 35px;">
					<div class="list-group" id="shu-daohanglan" style="width: 200px;">
						...
						<a href="others.jsp" class="list-group-item"
							style="background: #F5F5F5; color: #EE7621;">店铺管理</a>
						<a href="others_product.jsp"
							class="list-group-item" style="color: #000000;">产品管理</a>
				...
				<!-- 页面名称 -->
				<div>
					<p style="font-size: 18px; font-weight: bold;">店铺信息</p>
				</div>
				<!-- 搜索 -->
						...
						<div class="form-group"
							...
							<div class="col-sm-2" style="width: 150px; left: 0px; top: 8px;">
								<select class="form-control" name="search">
									...
									<option value="state_d_Cname">店铺名称</option>
									<option value="state_d_address">联系人</option>
									<option value="state_d_product">主打产品</option>
									<option value="state_d_supplier">供应商</option>
									<option value="state_d_supplier">供应商意见</option>
								</select>
							</div>
							<div class="col-sm-2"
								style="width: 400px; left: 60px; top: 10px;">
						...
						<thead>
							<tr>
								<th style="width: 35px;"><input id="checkAll"
									type="checkbox" /></th>
								<th width="180" align="center">店铺名称</th>
								<th width="200" align="center">联系人</th>
								<th width="350" align="center">主打产品</th>
								<th width="120" align="center">供应商</th>
								<th width="200" align="center">供应商意见</th>
								<th width="60" align="center">审核</th>
							</tr>

							<tr>
								<th style="width: 25px; background: #ffffff"><input
									id="checkAll" type="checkbox" /></th>
								<th width="100" align="center" bgcolor="#ffffff" id="c">reeyee旗舰店</th>
								<th width="100" align="center" bgcolor="#ffffff">曹植</th>
								<th width="250" align="center" bgcolor="#ffffff">男士商务双肩背包</th>
								<th width="100" align="center" bgcolor="#ffffff">reeyee</th>
								<th width="50" align="center" bgcolor="#ffffff">同意</th>
							...
							<tr>
								<th style="width: 25px; background: #a9bdd6"><input
									id="checkAll" type="checkbox" /></th>
								<th width="100" align="center" bgcolor="#a9bdd6" id="c">盛世九九图书专营店</th>
								<th width="100" align="center" bgcolor="#a9bdd6">方想</th>
								<th width="250" align="center" bgcolor="#a9bdd6">图书</th>
								<th width="100" align="center" bgcolor="#a9bdd6">盛世</th>
								<th width="50" align="center" bgcolor="#a9bdd6">同意</th>
							...
							<tr>
								<th style="width: 25px; background: #ffffff"><input
									id="checkAll" type="checkbox" /></th>
								<th width="100" align="center" bgcolor="#ffffff" id="c">fofo旗舰店</th>
								<th width="100" align="center" bgcolor="#ffffff">王雄</th>
								<th width="250" align="center" bgcolor="#ffffff">行李箱</th>
								<th width="100" align="center" bgcolor="#ffffff">fofo</th>
								<th width="50" align="center" bgcolor="#ffffff">不同意</th>
								<th width="60" align="center" bgcolor="#ffffff"><input type="button" value="通过" 
									style="color:red" id="b" onclick="change(this)" /></th>
							</tr>
							...
							<tr>
								<th style="width: 25px; background: #a9bdd6"><input
									id="checkAll" type="checkbox" /></th>
								<th width="100" align="center" bgcolor="#a9bdd6" id="c">谷物食品专营店</th>
								<th width="100" align="center" bgcolor="#a9bdd6">易天行</th>
								<th width="250" align="center" bgcolor="#a9bdd6">零食</th>
								<th width="100" align="center" bgcolor="#a9bdd6">友臣</th>
								<th width="50" align="center" bgcolor="#a9bdd6">不同意</th>
								<th width="60" align="center" bgcolor="#a9bdd6"><input type="button" value="通过" 
									style="color:red" id="b" onclick="change(this)" /></th>
							</tr>
							...
							<tr>
								<th style="width: 25px; background: #ffffff"><input
									id="checkAll" type="checkbox" /></th>
								<th width="100" align="center" bgcolor="#ffffff" id="c">小王子休闲食品批发</th>
								<th width="100" align="center" bgcolor="#ffffff">林修</th>
							...
							<tr>
								<th style="width: 25px; background: #a9bdd6"><input
									id="checkAll" type="checkbox" /></th>
								<th width="100" align="center" bgcolor="#a9bdd6" id="c">狼途酷聪专卖店</th>
								<th width="100" align="center" bgcolor="#a9bdd6">林毅</th>
							...
							<tr>
								<th style="width: 25px; background: #ffffff"><input
									id="checkAll" type="checkbox" /></th>
								<th width="100" align="center" bgcolor="#ffffff" id="c">卡特兔母婴旗舰店</th>
								<th width="100" align="center" bgcolor="#ffffff">罗玥</th>
